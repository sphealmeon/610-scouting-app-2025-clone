...
interface AlgaeBoxPlotChartProps {
  teamsData: Record<string, string[]>;
  title?: string;
}

const AlgaeBoxPlotChart = ({ teamsData, title = 'Team Algae Cycles Boxplot' }: AlgaeBoxPlotChartProps) => {
    ...
    datasets: [
      {
        label: 'Algae Cycles',
        data: boxplotData,
        backgroundColor: 'rgba(75, 192, 192, 0.2)', // Green tint for algae
        ...
        callbacks: {
          label: (context: any) => {
            ...
            return [
              ...
              `Matches: ${boxplotItem.outliers ? boxplotItem.outliers.length : 0}`
            ];
          }
        }
      }
...
export default AlgaeBoxPlotChart; 