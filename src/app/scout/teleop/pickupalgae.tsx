  ...
  return (
    <div className="col-span-1">
      ...
      <div className="flex flex-col gap-4">
        ...
        {/* Popup for feedback */}
        {popupVisible && (
          <div className="fixed bottom-24 left-1/2 transform -translate-x-1/2 bg-green-500 text-white px-4 py-2 rounded">
            Algae knocked off the reef!
          </div>
        )}
      </div>
    </div>
