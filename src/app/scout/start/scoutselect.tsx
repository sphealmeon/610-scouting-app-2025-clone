...
export default function ScoutSelect({ setMatchState }: { setMatchState: Function }) {
    ...
    return (
        <div className="flex flex-col justify-center items-center space-y-4">
            <Button
                className="mb-20 text-xl py-6 px-8 bg-green-900 text-white hover:bg-green-800 disabled:bg-gray-500"
            ...
            <Button
                className="text-xl py-6 px-8 bg-green-900 text-white hover:bg-green-700"
